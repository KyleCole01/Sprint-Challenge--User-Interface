...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
      Answer - I would say its what is needed to help others understand what your code is doing.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
      Answer - display:block takes up the width of the parent element and is essentially a new line character as well
               display:inline takes up the width of what is needed and isnt a new line character
3. What are the 4 areas of the box model?
      Answer - Content, Padding, Margin, Border
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
      Answer - the Vertical Axis
5. Explain why git is valuable to a team of developers.
      Answer - Allows multiple people to work on the same code simultaneously
